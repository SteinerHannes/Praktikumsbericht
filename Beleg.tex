...
\chapter{Hochschule Mittweida}
	Die Hochschule Mittweida - university of applied science (HSMW) \nomenclature{HSMW}{Hochschule Mittweida - university of applied science} ist ...
...
\chapter{Weitere Entwicklung und Besonderheiten}
	...
	\section{App-Architektur}
		- redux like app store miTobiast states erklären? (single source of truth)
...
\begin{thebibliography}{99}
	...
	\bibitem{visionBasicApp}
		Apple Developer Detecting Objects in Still Images
	...
	\bibitem{heise2019einsitegInSwiftUI}
		Sillmann, Thomas Einsteig in SwiftUI. 22.11.2019
