...
\chapter{Anforderungen}
	Es soll eine iOS-App entstehen mit der Klausuren digitalisiert werden können. Genauer müssen die, für die Notenfreigabe relevanten Daten der Klausur, in ein tabellarisches Format gebracht werden. Um unterschiedlichste Klausuren, Klausuren-Vorlagen oder auch andere Dokumente zu unterstützen, soll das Anlegen von Scan-Vorlagen in der App möglich sein. Diese enthalten jede Seite des Dokuments und alle Regionen der Seiten, in denen sich die zu digitalisierenden Informationen befinden. 
	
	
	
	Die App muss Berechtigung für das Kamera-System des Gerätes haben, damit der Benutzer in der Lage ist, jede Seite zu fotografieren. Ihm muss es außerdem möglich sein, die Regionen auf dem Fotos zu markieren und zu bezeichnen, damit die 
	...
	Die erstellten Vorlagen, die digitalisierten Daten und die für die Texterkennung entstandenen Dokumenten-Bilder, soll außerhalb der App auf einem Server gespeichert werden. Somit ist die Möglichkeit gegeben, die Vorlagen wieder zu verwenden und anderen Benutzern der App zur Verfügung zu stellen. 
