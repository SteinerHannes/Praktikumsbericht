...
\chapter{Einleitung}
	...
	Im Rahmen eines zwölfwöchigem Forschungspraktikums an der Hochschule Mittweida arbeiteten der Student Tobias Kallauke und ich, gemeinsam an einem Forschnungsprojekt von Memo Space. Dabei entwickelten wir ein Software-System, mit dem die Arbeit von vielen Hochschulmitarbeitern erleichtert und auch Zeit eingespart werden soll.

%%%%%%%%%%%%%%% - HSMW - %%%%%%%%%%%%%%%

\chapter{Hochschule Mittweida}
	Die Hochschule Mittweida - university of applied science (HSMW) \nomenclature{HSMW}{Hochschule Mittweida - university of applied science} wurde vor über 150 Jahren gegründet. Heute lehrt und forscht sie mit ca. 6000 Studenten in fünf Fakultäten und vier Forschungsschwerpunkten\footnote{Quelle: \href{https://www.hs-mittweida.de/hochschule/portrait.html}{\url{https://www.hs-mittweida.de/hochschule/portrait.html}}}. Eines der Schwerpunkte ist die angewandte Informatik, in dem Memo Space angesiedelt ist.
...
\chapter{Entwicklung des ersten Prototyps}
	...
	\section{Entwurf und Design}
		\subsection{Grundlagen}
			In den folgenden zwei Absätze werden wichtige Konzepte erklärt, die im Entwurf der App benutzt und nochmal aufgegriffen werden.
		...
		\subsection{Entwurf und Design}
			...
			Daher entschied ich mich die wesentlichen Konzepte von \textit{Redux} umzusetzen und einen \textit{Redux} ähnlichen State Container, als ViewModel zu implementieren. Dafür überlegte ich mir States sowie Aktionen der einzelnen States, die zwingend notwendig sind.
