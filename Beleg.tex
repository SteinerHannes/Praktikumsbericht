...
\chapter{Probleme und Grenzen der App}\label{ch:grenzen}
	...
	\section{Probleme der Klausur-Vorlage beim Scannen}
		Dieser Abschnitt bezieht sich ausschließlich auf entstandene Probleme mit der Klausuren-Vorlage, welche in Abbildung \ref{fig:klausur} zu sehen ist. Diese stand während des Praktikums als Beispiel-Klausur zur Verfügung. Im nächsten Kapitel \ref{ch:vorlage}, werden mögliche Änderungen und Lösungen zu den hier aufgeführten Problemen diskutiert.
...
\chapter{Scan-Vorlagen}\label{ch:vorlage}
